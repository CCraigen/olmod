        ...
        public class MPAutoSelectUI_UIElement_Draw
        {
            ...
            static void DrawAutoSelectWindow(UIElement uie)
            {
                ...
                for (int i = 0; i < 8; i++)
                {
                    ...
                    position.x -= 205f;
                    uie.SelectAndDrawItem(!MPWeaponCycling.CPrimaries[i] ? "+" : "-", position, 3000 + i, false, 0.022f, 1f);
                    position.x += 55f;
                    //position.x -= 150f;
                    ...
                    position2.x += 205f;
                    uie.SelectAndDrawItem((!MPWeaponCycling.CSecondaries[i] ? "+" : "-"), position2, 3010 + i, false, 0.022f, 1f);
                    position2.x -= 55f;
                    //position2.x += 150f;
